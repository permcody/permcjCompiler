...
* 8
 ...
 37:     ST  3,-9(1) 	Save index in temp 
 38:    LDC  3,666(6) 	Load constant 
 39:     LD  4,-9(1) 	load index from temp to ac1 
...
* 9
 ...
 44:     ST  3,-9(1) 	Save index in temp 
 45:    LDC  3,1(6) 	Load constant 
 46:     LD  4,-9(1) 	load index from temp to ac1 
 47:    LDA  5,-5(1) 	Load address of base of array b
 48:    SUB  5,5,4 	Compute offset of value 
 49:     ST  3,0(5) 	Store variable b
* 11
 50:     ST  1,-9(1) 	Store old fp in ghost frame 
 ...
 55:     ST  3,-11(1) 	Store parameter 
 56:    LDA  1,-9(1) 	Load address of new frame 
 57:    LDA  3,1(7) 	Return address in ac 
 58:    LDA  7,-48(7) 	call output
 59:    LDA  3,0(2) 	Save the result in ac 
* 12
 60:     ST  1,-9(1) 	Store old fp in ghost frame 
 61:    LDC  3,3(6) 	Load constant 
 62:    LDA  4,-5(1) 	Load address of base of array b
 63:    SUB  3,4,3 	Compute offset of value 
 64:     LD  3,0(3) 	Load the value 
 65:     ST  3,-11(1) 	Store parameter 
 66:    LDA  1,-9(1) 	Load address of new frame 
